...
keywordHandler:addKeyword(
	{"time"},
	StdModule.say,
	{npcHandler = npcHandler, text = "There is always time to make a change."}
)
keywordHandler:addKeyword(
	{"job"},
	StdModule.say,
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "father") and npcHandler:getTopic(playerId) == 0 then
		npcHandler:say(
			{
	...
	elseif
		MsgContains(message, "father") and npcHandler:getTopic(playerId) == 1 and
			player:getStorageValue(Storage.ForgottenKnowledge.Ivalisse) == 1 or
			player:getStorageValue(Storage.ForgottenKnowledge.Chalice) == 1
	 then
		npcHandler:say(
			{
				"Well, I hope you like it here. We tried to rebuild in the Shaper's will. I am a bit preoccupied at the moment because of the absence of my father. I may not be the best of help currently, sorry."
	...
	elseif
		MsgContains(message, "father") and npcHandler:getTopic(playerId) == 1 and
			player:getStorageValue(Storage.ForgottenKnowledge.DragonkingKilled) == 1
	 then
		npcHandler:say(
			{
