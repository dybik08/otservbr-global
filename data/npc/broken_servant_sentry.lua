...
local function creatureSayCallback(npc, creature, type, message)
	...
	if
		(MsgContains(message, "slime") or MsgContains(message, "mould") or MsgContains(message, "fungus") or
			MsgContains(message, "sample"))
	 then
	...
	elseif (MsgContains(message, "cap") or MsgContains(message, "mage")) then
		if
			(getPlayerItemCount(creature, 12599) >= 1 and getPlayerStorageValue(creature, Storage.ElementalistQuest1) == 2) and
				getPlayerStorageValue(creature, Storage.ElementalistQuest2) < 1
		 then
	...
	elseif (MsgContains(message, "staff") or MsgContains(message, "spike")) then
		if
			(getPlayerItemCount(creature, 12803) >= 1 and getPlayerStorageValue(creature, Storage.ElementalistQuest1) == 2) and
				getPlayerStorageValue(creature, Storage.ElementalistQuest3) < 1
		 then
			npcHandler:say(
				{
