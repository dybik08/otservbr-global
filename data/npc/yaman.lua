...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "cookie") then
		if
			player:getStorageValue(Storage.WhatAFoolish.Questline) == 31 and
				player:getStorageValue(Storage.WhatAFoolish.CookieDelivery.Djinn) ~= 1
		 then
...
npcConfig.shop = {
	...
	{itemName = "energy ring", clientid = 3051, name = "energy ring", buy = 2000, sell = 100},
	{itemName = "glacial rod", clientId = 16118, sell = 6500},
	{itemName = "hailstorm rod", clientId = 3067, sell = 3000},
	{itemName = "life ring", clientid = 3052, name = "life ring", buy = 900, sell = 50},
	...
	{itemName = "mysterious fetish", clientname = "mysterious fetish", sell = 50},
	...
	{itemName = "ring of healing", clientid = 3098, name = "Ring of healing", buy = 2000, sell = 100},
	{itemName = "silver amulet", clientname = "silver amulet", buy = 100, sell = 50, count = 200},
