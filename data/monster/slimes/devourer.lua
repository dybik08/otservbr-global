...
monster.loot = {
	...
	{id = 3035, name = "platinum coin", chance = 9100, maxCount = 2},
	{id = 21182, chance = 1670},
	{id = 3034, chance = 940},
	{name="small sapphire", chance = 1170, maxCount = 3},
	{name="small amethyst", chance = 1030, maxCount = 3},
	{name="small topaz", chance = 1030, maxCount = 3},
	{name="small emerald", chance = 1170, maxCount = 3},
	{name="small ruby", chance = 1190, maxCount = 3},
	{name="small diamond", chance = 1050, maxCount = 3},
	{name="yellow gem", chance = 1090},
	{id = 3038, chance = 100},
	{id = 21164, chance = 210},
	{id = 21183, chance = 130},
	{id = 21179, chance = 350},
