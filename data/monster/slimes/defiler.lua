...
monster.loot = {
	...
	{id = 3035, name = "platinum coin", chance = 95000, maxCount = 6},
	{name = "yellow gem", chance = 1219},
	{name = "green gem", chance = 613},
	{id = 3039, name = "red gem", chance = 1538},
	{name = "blue gem", chance = 300},
	{name = "soul orb", chance = 20000},
	{id = 6299, name = "death ring", chance = 3030},
...
monster.attacks = {
	{
		...
		minDamage = 0,
		maxDamage = -240,
		condition = {type = CONDITION_POISON, totalDamage = 150, interval = 4000}
	},
	{
		name = "combat",
		interval = 2000,
