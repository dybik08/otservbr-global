...
monster.loot = {
	...
	{id = 3035, name = "platinum coin", chance = 10390},
	{id = 236, chance = 10310},
	{id = 237, chance = 9990},
	{id = 21182, chance = 4320},
	{id = 3052, name = "life ring", chance = 1630}, -- Life ring
	{name = "small sapphire", chance = 1110},
	{name = "small topaz", chance = 1140, maxCount = 2},
	{name = "small emerald", chance = 940, maxCount = 2},
	{id = 3038, chance = 80},
	{id = 21183, chance = 130},
	{id = 21180, chance = 60},
	{id = 21158, chance = 460}
...
monster.attacks = {
	{
		...
		skill = 58,
		attack = 50,
		condition = {type = CONDITION_POISON, totalDamage = 280, interval = 4000}
	},
	{
		name = "combat",
		interval = 2000,
