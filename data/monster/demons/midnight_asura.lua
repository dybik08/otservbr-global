...
-- sorted descending
monster.loot = {
	{name = "platinum coin", chance = 80660, maxCount = 6},
...
monster.attacks = {
	...
	{name ="shortVioletElectricBeam", interval = 2000, chance = 10, minDamage = 0, maxDamage = -110},

	-- Death Strike (0-200 death, on target)
	{name ="deathStrike", interval = 2000, chance = 10, minDamage = -0, maxDamage = -200},

	-- Dizzy Ball (on target, effect: drunk)
	{name ="dizzyBall", interval = 2000, chance = 10, minDamage = -50, maxDamage = -200},

	-- Great Black Steam Wave (0-210 life drain)
	{name ="blackSteamWave", interval = 2000, chance = 10, minDamage = -0, maxDamage = -210},
}
...
monster.defenses = {
	...
	armor = 55,
		-- Invisible
		{name ="invisible", interval = 2000, chance = 15, effect = SPELL_ANIMATIONS.RED_STARS, target = false,  duration = 5000},
		-- Healing
		{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 50, effect = SPELL_ANIMATIONS.BLUE_STARS, maxDamage = 100, target = false}
	}
