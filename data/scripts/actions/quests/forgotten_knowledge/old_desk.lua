...
function forgottenKnowledgeOldDesk.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	player:sendTextMessage(
		...
		"As you open the drower a ghostly apparition shortly appears hovering over the desk. You find an old note inside of the drower."
	)
	item:getPosition():sendMagicEffect(SPELL_ANIMATIONS.WHITE_SHADE)
