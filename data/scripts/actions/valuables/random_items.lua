local config = {
	...
	[14172] = { -- gooey mass
		chances = {
			...
			{from = 2168, to = 4243, itemid = 3035, name = "platinum coin", count = 2},
			{from = 4244, to = 6196, itemname="black pearl", count = 2},
			{from = 6197, to = 8149, itemname="great health potion", count = 2},
			{from = 8150, to = 9823, itemname="great mana potion", count = 2},
	...
	[15698] = { -- gnomish supply package
		chances = {
			...
			{from = 8629, to = 8932, itemid = 3035, name = "platinum coin", count = 5},
